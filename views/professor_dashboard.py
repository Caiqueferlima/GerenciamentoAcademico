...
class ProfessorDashboard(QWidget):
    ...
    def _build_ui(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton { background: #55c2d8; color: #09202b; border: 0; border-radius: 6px; padding: 10px 16px; font-weight: bold; }
            QPushButton:hover { background: #78d4e4; }
            QPushButton:pressed { background: #3ca7bd; }
